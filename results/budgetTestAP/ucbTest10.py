...
class ucbtest(object):
    ...
    def ucb1(self,numActions,K,tau):
        ...
        self.timeTake=math.floor(self.numRounds/self.gamma)
        self.timeTake1=self.timeTake
        print self.gamma,self.timeTake1,self.timeTake
        ...
        while True:
            ...
            if self.t >= self.timeTake1:

                print "\n\nRound: "+str(self.m) + " timeTake1: "+str(self.timeTake1)
                ...
                #self.timeTake=self.timeTake + math.floor(self.timeTake*self.gamma)
                self.timeTake1=self.timeTake1+self.timeTake
                self.m = self.m + 1
        ...
        f = open('testFinal1/testAugUCB1.txt', 'a')
...
if __name__ == "__main__":
    ...
    while i<=10:
        ...
        for j in range(1000):
            ...
            f = open('testFinal1/testAugUCBtest1.txt', 'a')
