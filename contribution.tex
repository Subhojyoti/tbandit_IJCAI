...
AugUCB      &
$\exp\left( -\frac{T\log ( \frac{1}{2} K\log K)}{ 32 H_2 K\log K} + \log\left(K\left(\log_2\frac{T}{e}\right)\right)\right)$\newline
 $+$ \newline  
 $ \exp\left(- \frac{T\log ( \frac{3}{16} K\log K)}{256 H_{2}^{\sigma} K(\log K)}
 + \log\left(2K\left(\log_2\frac{T}{e}\right)\right) \right) $
\\\bottomrule
\end{tabular}
\end{center}
\end{table}
