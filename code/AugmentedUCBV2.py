...
class AugUCB(object):
    ...
    def exp_func(self):
        ...
        #self.psi = ( self.numRounds*self.delta_tilda) / (64.0 *math.log( self.numActions*self.numActions) )
        self.psi = ( self.numRounds*self.delta_tilda) / (1.0 * self.numActions * math.log(self.numActions))
    ...
    def upperBound(self, numPlays):
        ...
        return math.sqrt(self.rho * self.exp_func() * math.log((self.numRounds*self.delta_tilda)) / (2*numPlays))
    ...
    def upperBoundVar(self, numPlays, arm):
        ...
        #print vj
        return math.sqrt(self.rho_v * vj * self.exp_func()* math.log((self.numRounds*self.delta_tilda)) / (4*numPlays) + (self.rho_v* math.log((self.exp_func()*self.numRounds*self.delta_tilda)) / (4*numPlays)))
    ...
    def augucb(self,numActions,K,tau):
        ...
        self.nm=math.ceil(2*self.exp_func()*math.log(self.numRounds*self.delta_tilda)/self.delta_tilda)
        ...
        while True:
            ...
            for i in range(self.numActions):
                if self.B[i]==0:
                    ...
                    self.ucbs[i]=abs(self.avgPayOffSums[i]-self.tau) - 2.0*self.upperBoundVar(self.numPlays[i],i)
        ...
        f = open('testFinal7/testAugUCBV_1_12.txt', 'a')
...
if __name__ == "__main__":
    ...
    while i<=100:
        ...
        for j in range(500):
            ...
            f = open('testFinal7/testAugUCBVtest_1_12.txt', 'a')
